<div class="container-fluid bg-white mt-5">
 	<div class="row">
 		<div class="col-lg-4 p-4">
 			<h3 class="h-font fw-bold fs-3 mb-2">BL HOTEL</h3>
 			<p>Chào mừng bạn đến với BL Hotel, nơi chúng tôi tận tâm phục vụ và đem đến cho bạn trải nghiệm độc đáo và hoàn hảo tại trái tim của thành phố Đà Nẵng. Với vị trí tốt ngay tại trung tâm, chúng tôi tự hào là điểm đến lý tưởng cho du khách, người đi công tác và những người tìm kiếm sự thoải mái và tiện nghi.</p>
 		</div>
 		<div class="col-lg-4 p-4">
 			...
 			<a href="#" class="d-inline-block mb-2 text-dark text-decoration-none">Giới Thiệu</a>
 		</div>
 		<div class="col-lg-4 p-4">
...
<h6 class="text-center bg-dark text-white p-3 m-0">@BL Hotel</h6>
