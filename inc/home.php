		...
		<div class="row">
			...
			<div class="col-lg-4 col-md-4 ">
				<div class="bg-white p-4 rounded">
					...
					<a href="tel: +94768799665" class="d-inline-block mb-2 text-decoration-none text-dark"><i class="bi bi-telephone-fill"></i> +84 123456789</a>
					<br>
					<a href="tel: +94768799665" class="d-inline-block mb-2 text-decoration-none text-dark"><i class="bi bi-telephone-fill"></i> +84 987654321</a>
				</div>
				<div class="bg-white p-4 rounded">
					<h5>Follow</h5>
